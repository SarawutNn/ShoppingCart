...
public class ShoppingCartCalculator {
     ...
     * การซื้อสินค้าแบบมีส่วนลด(BOGO) เป็นการซื้อ 1 แถม 1
     * เช่น เมื่อซื้อสินค้า 4 ชิ้น จะจ่ายในราคาเพียง 2 ชิ้น
     * การซื้อสินค้าแบบมีส่วนลด(BULK) เป็นการซื้อสินค้าตั้งแต่จำนวน 6 ชิ้นขึ้นไป จะลด 10%
